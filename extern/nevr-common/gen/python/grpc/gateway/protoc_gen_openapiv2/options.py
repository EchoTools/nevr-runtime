...
class Swagger(betterproto.Message):
    ...
    gateway/blob/main/LICENSE";      };    };    schemes: HTTPS;    consumes:
    ...
    # extensions/
    extensions: Dict[str, protobuf.Value] = betterproto.map_field(
...
class EnumSchema(betterproto.Message):
    ...
    https://github.com/OAI/OpenAPI-
    Specification/blob/3.0.0/versions/2.0.md#schemaObject Example:  option
    (grpc.gateway.protoc_gen_openapiv2.options.openapiv2_enum) = {    ...
    title: "MyEnum";    description:"This is my nice enum";    example: "ZERO";
    required: true;    ...  };
    """
...
class JSONSchema(betterproto.Message):
    ...
    # extensions/
    extensions: Dict[str, protobuf.Value] = betterproto.map_field(
        48, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )
