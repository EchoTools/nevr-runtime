...
@dataclass
class ListGuildGameServersResponse(betterproto.Message):
    """Response wrapper for ListGuildGameServers RPC."""

    result: "GuildGameServerList" = betterproto.message_field(1)


@dataclass
class LobbySessionCreateResponse(betterproto.Message):
    """Response wrapper for LobbySessionCreate RPC."""

    result: "Match" = betterproto.message_field(1)
