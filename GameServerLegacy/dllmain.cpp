...
HRESULT RadPluginMain(CHAR* x) { return ERROR_SUCCESS; }
HRESULT RadPluginSetAllocator(VOID* x) { return ERROR_SUCCESS; }
HRESULT RadPluginSetEnvironment(VOID* x) { return ERROR_SUCCESS; }
HRESULT RadPluginSetEnvironmentMethods(VOID* x, VOID* y) { return ERROR_SUCCESS; }
HRESULT RadPluginSetFileTypes(VOID* x) { return ERROR_SUCCESS; }
HRESULT RadPluginSetPresenceFactory(VOID* x) { return ERROR_SUCCESS; }
HRESULT RadPluginSetSymbolDebugMethodsMethod(VOID* a, VOID* b, VOID* c, VOID* d) { return ERROR_SUCCESS; }
...
EchoVR::IServerLib* ServerLib() {
  ...
  // Print out that it got here
  OutputDebugStringA("ServerLib function called.\n");
