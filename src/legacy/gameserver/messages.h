...
// ServerDB internal protocol messages
const EchoVR::SymbolId SYMBOL_SERVERDB_PROTOBUF_ENVELOPE = 0x9ee5107d9e29fd63ULL;
const EchoVR::SymbolId SYMBOL_SERVERDB_BROADCASTER_REGISTRATION_SUCCESS = 0xb57a31cdd0f6fedfULL;
const EchoVR::SymbolId SYMBOL_SERVERDB_TCP_CONNECTION_UNREQUIRE = 0x43e6963ac76beee4ULL;
const EchoVR::SymbolId SYMBOL_SERVERDB_LOBBY_ENTRANTS_V3 = 0xa1b9cae1f8588969ULL;
