...
verify:
    ...
    if [ "$TEST_COUNT" -lt 172 ]; then
        echo "verify: FAIL — runtime GTest count fell to $TEST_COUNT (floor 172)." >&2
        exit 1
    fi
    echo "verify: runtime GTest declarations=$TEST_COUNT (floor 172)"
