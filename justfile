...
verify:
    ...
    if [ "$TEST_COUNT" -lt 173 ]; then
        echo "verify: FAIL — runtime GTest count fell to $TEST_COUNT (floor 173)." >&2
        exit 1
    fi
    echo "verify: runtime GTest declarations=$TEST_COUNT (floor 173)"
