...
verify:
    ...
    if [ "$TEST_COUNT" -lt 179 ]; then
        echo "verify: FAIL — runtime GTest count fell to $TEST_COUNT (floor 179)." >&2
        exit 1
    fi
    echo "verify: runtime GTest declarations=$TEST_COUNT (floor 179)"
